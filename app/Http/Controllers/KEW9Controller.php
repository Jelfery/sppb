...
class KEW9Controller extends Controller
{
    ...
    public function index(){
        ...
        return View::make('KEW9.index', compact('records', 'templates', 'user'));
    }
    ...
    public function store(Request $request){
        ...
        // Move Uploaded File
        $destinationPath = 'KEW9/'.Carbon::now()->year.'/'.$full_month.'/'.$filename;
    ...
    public function get($id){
    	...
    	$path = storage_path(). "/records/KEW9/".$year.'/'.$month.'/'.$file->name;
    ...
    public function getCollection(Request $request){
        ...
        $path = storage_path(). "/records/KEW9/".$request->year;
        ...
        if (File::isDirectory($path)) {
            ...
            $zipPath = storage_path()."/records/KEW9/collection/".$filename;
