...
@section ('content')
	<div class="container">
					...
					<table class="table table-hovered" id="myTable">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a href="{{route('dummyvot::getRecord', $record->id)}}" class="btn btn-primary btn-sm" role="button">Muat Turun Fail</a>
							...
							<div id="deleteModal-{{ $record->id }}" class="modal fade">
								<div class="modal-dialog modal-sm">
									<div class="modal-content">
										...
										{!! Form::open(['route' => ['dummyvot::deleteRecord', $record->id]]) !!}
		...
		<div class="card" style="padding-bottom: 16px">
			...
			{!! Form::open(array('url' => '/dummyvot/collection', 'class' => 'form')) !!}
		...
		<div class="card" style="margin-bottom: 16px">
					...
					<table class="table table-hovered">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a href="{{route('dummyvot::getTemplate', $template->id)}}" class="btn btn-primary btn-sm" role="button">Muat Turun Fail</a>
								</td>
							</tr>
							@empty
							<tr>
			...
			{!! Form::open( ['route' => 'dummyvot::store', 'novalidate' => 'novalidate', 'class' => 'form', 'files' => true]) !!}
